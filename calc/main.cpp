...
int main() {
    ...
    Stock  stock        = Stock(95,0.1,0.05,0.3);
    ...
    pricer.FourierInversionPricer(1e4,INF,"RN Prob");
    pricer.FourierInversionPricer(1e4,INF,"Lewis");
    pricer.FourierInversionPricer(1e4,INF,"FFT");
    return 0;
}
